...
// #region Custom Mushroom Selectors
type MushAlignementSelector = {
    mush_alignment: {};
};

type MushColorSelector = {
    mush_color: {};
};

type MushIconTypeSelector = {
    mush_icon_type: {};
};

type MushInfoSelector = {
    mush_info: {
        infos?: Info[];
    };
};

type MushLayoutSelector = {
    mush_layout: {};
};
